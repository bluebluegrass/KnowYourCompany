...
export const SECTION_DEFINITIONS: SectionDefinition[] = [
  ...
  { id: "financial_health", order: 2, title: "Financial Health", shortLabel: "Financial", maxQueries: 6, maxFetchedPages: 8, maxEvidenceItems: 12, maxCommunityItems: 1, recencyMonths: 24, allowDurableSources: false, highValueLocalLanguage: true },
