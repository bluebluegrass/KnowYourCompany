...
function sectionKeywords(sectionId: EvidenceSnippet["sectionId"]): string[] {
  switch (sectionId) {
    ...
    case "financial_health":
      return ["earnings", "annual report", "quarterly", "revenue", "operating income", "net income", "free cash flow", "cash", "debt", "funding", "valuation", "investor", "series", "ipo", "going public", "acquisition", "private equity", "runway", "profit"];
